...
import PieApp from "../components/Chart";
...
const Dashboard = () => {
  ...
  return (
    <div className='h-full py-4'>
      <>
        ...
        <div className="w-full flex flex-col lg:flex-row p-2 mr-4 gap-8">
  
  {/* Priority Chart */}
  <div className="w-full lg:w-1/2 bg-white my-4 p-4 rounded shadow-sm">
  ...
  {/* Stage Chart */}
  <div className="w-full lg:w-1/2 bg-white flex justify-center flex-col items-center my-4 p-4 rounded shadow-sm">
    <h4 className="text-xl text-gray-500 font-bold mb-2">
      Tasks by Stage
    </h4>
    <PieApp data={data?.pieData} />
  </div>
